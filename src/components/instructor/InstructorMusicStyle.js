...
import { getAppUser, updateAppUser } from './InstructorManager'
import "./Instructor.css"

function InstructorMusicStyle() {
        ...
        <>
            ...
            <section className="instructor instructor__music-style bg-light">
                <div className="container flow-content flow-content--large">
                    ...
                    <p className="h2">Which music style do you prefer to teach?</p>
...
export default InstructorMusicStyle